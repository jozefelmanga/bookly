    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="carousel_6ac2" data-image-width="1366" data-image-height="768">
      <div class="u-clearfix u-sheet ">
        <div class="u-align-center u-form u-palette-3-light-3 u-radius-50 u-form-1">
          <form action="SUP.php" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 30px;background-color: #f2e5d0; border-radius: 20px; margin-top: 10px;" method="post">
            <h3 class="u-align-center u-custom-font u-font-ubuntu u-form-group u-form-text u-label-top u-text u-text-custom-color-4 u-text-1" data-animation-name="bounceIn" data-animation-duration="2250" data-animation-direction="" style=" margin: 20px;">modifier</h3>
