...
<script>
  ...
  <?php
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $sql = "select * from etudiants where NCE='$id' ";
            $sth = $bdd->query($sql);
            $result = $sth->fetch();
            // print_r($result);
            $nom=$result[1];
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="carousel_6ac2" data-image-width="1366" data-image-height="768">
      <div class="u-clearfix u-sheet ">
        <div class="u-align-center u-form u-palette-3-light-3 u-radius-50 u-form-1">
          <form action="EUP.php" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 30px;background-color: #f2e5d0; border-radius: 20px; margin-top: 10px;" method="post">
            <h3 class="u-align-center u-custom-font u-font-ubuntu u-form-group u-form-text u-label-top u-text u-text-custom-color-4 u-text-1" data-animation-name="bounceIn" data-animation-duration="2250" data-animation-direction="" style=" margin: 20px;">modifier etudiant</h3>
            <div class="u-form-group u-form-partition-factor-2 u-label-top u-form-group-2">
              ...
              <input type="text" placeholder="donner votre nom" id="text-47df" name="nom" class="u-grey-5 u-input u-input-rectangle u-radius-22" style="background-color: #f9f3ee;" value="<?php echo $nom?>">
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-label-top">
              ...
              <input type="text" placeholder="donner votre prénom" id="name-66b3" name="prenom" class="u-grey-5 u-input u-input-rectangle u-radius-22" style="background-color: #f9f3ee;" spellcheck="false" value="<?php echo $prenom?>">
            </div>
            <input type="text" value="<?php echo $result[0]?>" name="id" hidden>
            ...
            <div class="u-form-group u-form-input-layout-horizontal u-form-radiobutton u-label-top u-form-group-8">
              ...
              <div class="u-form-radio-button-wrapper">
               <div class="u-input-row">
                  <input type="radio" name="sexe" value="feminin"<?php if ($sexe=="f") {?> checked<?php }?>>
                  <label class="u-label u-label-9" for="sexe">feminin</label>
                </div>
                <div class="u-input-row">
                  <input type="radio" name="sexe" value="masculin"<?php if ($sexe=="m") {?> checked<?php }?>>
            ...
            <div class="u-form-group u-form-select u-label-top u-form-group-9">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-4852" name="etat" class="u-grey-5 u-input u-input-rectangle u-radius-22"style="background-color: #f9f3ee;">
                  <option value="célibataire" <?php if ($etat=="c") {?> selected<?php }?>>célibataire</option>
                  <option value="marié" <?php if ($etat=="m") {?> selected<?php }?>>marié</option>
                </select>
                <svg class="u-caret u-caret-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve"><polygon class="st0" points="8,12 2,4 14,4 "></polygon></svg>
              </div>
            </div>
