    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="carousel_6ac2" data-image-width="1366" data-image-height="768">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-form u-palette-3-light-3 u-radius-50 u-form-1">
          <form action="ajL.php" class="u-clearfix u-form-spacing-25 u-form-vertical u-inner-form" source="email" name="form" style="padding: 30px;background-color: #f2e5d0; border-radius: 20px; margin-top: 10px;" method="post">
            ...
            <div class="u-form-group u-form-partition-factor-2 u-label-top u-form-group-2">
              ...
              <input type="text" placeholder="donner le titre" id="text-47df" name="titre" class="u-grey-5 u-input u-input-rectangle u-radius-22" style="background-color: #f9f3ee;">
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-label-top">
              ...
              <input type="text" placeholder="donner l'auteur" id="name-66b3" name="auteur" class="u-grey-5 u-input u-input-rectangle u-radius-22"  spellcheck="false" style="background-color: #f9f3ee;">
            </div>
            ...
            <div class="u-form-group u-label-top u-form-group-5">
              ...
              <input type="text" placeholder="editeur" id="text-e75e" name="editeur" class="u-grey-5 u-input u-input-rectangle u-radius-22" style="background-color: #f9f3ee;">
            </div>
            <div class="u-form-group u-form-textarea u-label-top u-form-group-6">
              ...
              <textarea rows="4" cols="50" id="textarea-adef" name="description" class="u-grey-5 u-input u-input-rectangle u-radius-22"  placeholder="description de votre livre" style="background-color: #f9f3ee;"></textarea>
            </div>
            <div class="u-form-group u-label-top u-form-group-5">
              <label for="text-e75e" class="u-label u-label-4">quantité</label>
              <input type="number" placeholder="quantite" id="text-e75e" name="quantite" class="u-grey-5 u-input u-input-rectangle u-radius-22" style="background-color: #f9f3ee;">
            </div>
